...
## Three-server strict User Guide acceptance and GCP 1 fix candidate (2026-08-02)
...
- GCP 1 currently runs a hot-deployed candidate, not a new immutable image. The API image remains `sha256:6971bb9fda6b4dd9ce08f6b18803753309d5b7cf92da7da2f76ae9e12594b934`; `/app/agent.py` is `adf0b4d34766d004b3906ecb159b36279608c455aa750835850ac40b2fce68c3` and `/app/shared/file_reference_resolver.py` is `98335f43d4ec040556329b9d7a246f49fbda0952f275d4f0dfa2e94a1407930e`. Rollback points are `~/csis-platform/backups/20260802_acceptance_fix_2e03567/` and `~/csis-platform/backups/20260802_workflow_guard_b38e4f3/`.
...
- Only GCP 1 has the clarified CBC external Guide at this checkpoint: MD SHA-256 `e7f5d17a4fb4f847e6d492738a9a16f05fef012567a841ca141fd24f03462cfd`, PDF SHA-256 `f052b53f78aa73bece76004e212db381b8b359c426529a0f21a808ee38bbea60`. GCP 2/MSU source, image, and Guide promotion remains pending explicit user approval and must use one immutable backend image.
