        @echo off
        REM ================================================================
        REM  Tool: Urban Stormwater Retention
        REM  Tool call name: run_urban_stormwater_retention
        ...
        REM      "Prompt: run urban stormwater retention model"
        ...
        REM     from tools.stormwater import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Requires: LULC TIF, soil group TIF, precipitation CSV, biophysical table CSV
Prompt: run urban stormwater retention model
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Urban Stormwater Retention
        echo.
