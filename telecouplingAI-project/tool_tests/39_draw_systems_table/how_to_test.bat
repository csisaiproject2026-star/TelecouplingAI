        @echo off
        REM ================================================================
        REM  Tool: Draw Systems from Table
        REM  Tool call name: run_draw_systems_from_table
        ...
        REM      "Prompt: draw systems from table file systems_table.csv, x_col=longitude, y_col=latitude, name_col=name"
        ...
        REM     from tools.systems_table import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Upload: testdata/systems_table.csv
Prompt: draw systems from table file systems_table.csv, x_col=longitude, y_col=latitude, name_col=name
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Draw Systems from Table
        echo.
