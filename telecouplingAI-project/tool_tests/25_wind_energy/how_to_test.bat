        @echo off
        REM ================================================================
        REM  Tool: Offshore Wind Energy
        REM  Tool call name: run_offshore_wind_energy
        ...
        REM      "Prompt: run offshore wind energy model"
        ...
        REM INPUT FILES
        REM -----------
        REM Requires: wind data CSV, bathymetry TIF, land polygon SHP, AOI SHP, biophysical table CSV
Prompt: run offshore wind energy model
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Offshore Wind Energy
        echo.
