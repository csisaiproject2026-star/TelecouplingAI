        @echo off
        REM ================================================================
        REM  Tool: Scenario Generator (Proximity)
        REM  Tool call name: run_scenario_gen_proximity
        ...
        REM      "Prompt: run scenario generator proximity model"
        ...
        REM     from tools.gen_proximity import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Requires: LULC TIF, transition weights CSV
Prompt: run scenario generator proximity model
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Scenario Generator (Proximity)
        echo.
