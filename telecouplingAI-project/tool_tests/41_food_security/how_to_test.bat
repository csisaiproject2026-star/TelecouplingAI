        @echo off
        REM ================================================================
        REM  Tool: Food Security Analysis
        REM  Tool call name: run_food_security
        ...
        REM      "Prompt: run food security analysis, countries=China,India,USA, indicator_field=Value"
        ...
        REM     from tools.security import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Upload: testdata/fao_food_security.csv
Prompt: run food security analysis, countries=China,India,USA, indicator_field=Value
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Food Security Analysis
        echo.
