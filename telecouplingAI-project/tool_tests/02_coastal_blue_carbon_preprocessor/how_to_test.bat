        @echo off
        REM ================================================================
        REM  Tool: Coastal Blue Carbon Preprocessor
        REM  Tool call name: run_coastal_blue_carbon_preprocessor
        ...
        REM      "Prompt: run Coastal Blue Carbon Preprocessor, snapshots=snapshots.csv, lookup=lulc_lookup.csv"
        ...
        REM     from tools.blue_carbon_preprocessor import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Upload: snapshots.csv, lulc_lookup.csv, GBJC_*.tif (x3)
Data path: ../datainput_for_demo/CoastalBLueCarbonPreprocessor_input/
Prompt: run Coastal Blue Carbon Preprocessor, snapshots=snapshots.csv, lookup=lulc_lookup.csv
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Coastal Blue Carbon Preprocessor
        echo.
