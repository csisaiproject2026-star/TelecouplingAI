        @echo off
        REM ================================================================
        REM  Tool: Nutrition Metrics (LLER)
        REM  Tool call name: run_nutrition_metrics
        ...
        REM      "Prompt: run nutrition metrics, age_col=age_group, sex_col=sex, weight_col=weight_kg, population_col=population"
        ...
        REM     from tools.metrics import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Upload: testdata/nutrition_data.csv
Prompt: run nutrition metrics, age_col=age_group, sex_col=sex, weight_col=weight_kg, population_col=population
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Nutrition Metrics (LLER)
        echo.
