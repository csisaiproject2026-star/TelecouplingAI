        @echo off
        REM ================================================================
        REM  Tool: Recreation & Tourism
        REM  Tool call name: run_recreation_tourism
        ...
        REM      "Prompt: run recreation tourism model"
        ...
        REM     from tools.recreation import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Requires: AOI SHP, scenario SHP (optional), predictor table CSV
Prompt: run recreation tourism model
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Recreation & Tourism
        echo.
