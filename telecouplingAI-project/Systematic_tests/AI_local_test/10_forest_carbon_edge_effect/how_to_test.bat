        @echo off
        REM ================================================================
        REM  Tool: Forest Carbon Edge Effect
        REM  Tool call name: run_forest_carbon_edge_effect
        ...
        REM      "Prompt: run forest carbon edge effect model"
        ...
        REM     from tools.carbon_edge_effect import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Requires: LULC TIF, edge carbon model CSV
Prompt: run forest carbon edge effect model
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Forest Carbon Edge Effect
        echo.
