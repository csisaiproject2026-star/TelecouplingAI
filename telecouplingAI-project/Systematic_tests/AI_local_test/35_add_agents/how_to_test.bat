        @echo off
        REM ================================================================
        REM  Tool: Add Agents Interactively
        REM  Tool call name: run_add_agents_interactively
        ...
        REM      "Prompt: add agents from agents.csv, x_col=longitude, y_col=latitude, name_col=agent_name"
        ...
        REM     from tools.agents import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Upload: testdata/agents.csv
Prompt: add agents from agents.csv, x_col=longitude, y_col=latitude, name_col=agent_name
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Add Agents Interactively
        echo.
