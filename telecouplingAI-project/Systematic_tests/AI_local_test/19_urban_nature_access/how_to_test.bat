        @echo off
        REM ================================================================
        REM  Tool: Urban Nature Access
        REM  Tool call name: run_urban_nature_access
        ...
        REM      "Prompt: run urban nature access model"
        ...
        REM     from tools.nature_access import *
        REM     # See SKILL.md for exact parameter format
        REM   "
        REM
        REM INPUT FILES
        REM -----------
        REM Requires: LULC TIF, population TIF, admin boundaries SHP, urban nature supply CSV
Prompt: run urban nature access model
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Urban Nature Access
        echo.
