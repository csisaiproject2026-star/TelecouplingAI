        @echo off
        REM ================================================================
        REM  Tool: Scenic Quality
        REM  Tool call name: run_scenic_quality
        ...
        REM      "Prompt: run scenic quality model"
        ...
        REM INPUT FILES
        REM -----------
        REM Requires: DEM TIF, viewpoints SHP, AOI SHP
Prompt: run scenic quality model
        REM
        REM OUTPUT FILES go to: output/
        REM ================================================================
        echo Test guide for: Scenic Quality
        echo.
